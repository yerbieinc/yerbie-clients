...
public class YerbieClient {
  ...
  public <D> String scheduleJob(Duration delay, String queue, D jobData) {
    return schedule(
        delay.toSeconds(), queue, jobData, DEFAULT_RETRY_POLICY, SerializationFormat.JSON);
  }

  public <D> String scheduleJob(Duration delay, String queue, D jobData, RetryPolicy retryPolicy) {
    return schedule(delay.toSeconds(), queue, jobData, retryPolicy, SerializationFormat.JSON);
  }
